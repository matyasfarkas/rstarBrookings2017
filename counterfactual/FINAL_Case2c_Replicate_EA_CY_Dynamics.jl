...
if use_FG_in_EA
    savefig(p_3x2, joinpath(figroot, "Case2c Exorbitant privilege 3x2 baseline_plus_delta.pdf"))
    savefig(p_3x2, joinpath(figroot, "Case2c Exorbitant privilege 3x2 baseline_plus_delta.png"))
else
    savefig(p_3x2, joinpath(figroot, "Case2c Exorbitant privilege without FG shocks in EA 3x2 baseline_plus_delta.pdf"))
    savefig(p_3x2, joinpath(figroot, "Case2c Exorbitant privilege without FG shocks in EA 3x2 baseline_plus_delta.png"))
end
