...
plot!(size=(960,540))
savefig( "Main results/EA_What_if_real_rate_gap_change_HLW_using_all_shocks.pdf")   # saves the plot from p as a .pdf vector graphic
...
savefig(plt, "Main results/compare_EA_baseline_vs_HLW_change_allshocks_ex_ante_realrate.pdf")
...
savefig(plt2, "Main results/compare_EA_baseline_vs_HLW_change_only_inflation_and_output_allshocks.pdf")
