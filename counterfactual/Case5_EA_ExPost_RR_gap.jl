...
plot!(size=(960,540))
savefig( "Main results/EA_What_if_real_rate_gap_change_HLW_using_policy_rate_shock.pdf")   # saves the plot from p as a .pdf vector graphic
...
savefig(plt, "Main results/compare_EA_baseline_vs_HLW_change_only_ex_ante_realrate.pdf")
...
savefig(plt2, "Main results/compare_EA_baseline_vs_HLW_change_only_inflation_and_output.pdf")
