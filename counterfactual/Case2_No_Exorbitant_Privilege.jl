...
folder_path = joinpath(basepath, "counterfactual", "rstarobs_plus_convyieldobs")
...
CSV.write("counterfactual/rstarobs_plus_convyieldobs/TTT.csv",DataFrame(TTT,state_labels))
CSV.write("counterfactual/rstarobs_plus_convyieldobs/RRR.csv",DataFrame(RRR,shock_labels))
CSV.write("counterfactual/rstarobs_plus_convyieldobs/CCC.csv",DataFrame(CCC',state_labels))
CSV.write("counterfactual/rstarobs_plus_convyieldobs/QQ.csv",DataFrame(QQ,shock_labels))
CSV.write("counterfactual/rstarobs_plus_convyieldobs/ZZ.csv",DataFrame(ZZ',obs_labels))
CSV.write("counterfactual/rstarobs_plus_convyieldobs/DD.csv",DataFrame(DD',obs_labels))
CSV.write("counterfactual/rstarobs_plus_convyieldobs/EE.csv",DataFrame(EE,obs_labels))
