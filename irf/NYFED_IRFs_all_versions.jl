...
plot(1:horizon,[pseudo_irf10[m10.pseudo_observables[:Forward5YearRealNaturalRate],:, m10.exogenous_shocks[:b_liqp_sh]] ],title="IRFs of r* to permanent liquidity shock", label=["Basline model" "No FG model"])
plot!(legend=:bottomright)
savefig( "irf/all/IRF_rstar_to_permanet_liquidity_shock.pdf")   # saves the plot from p as a .pdf vector graphic

plot(1:horizon,[pseudo_irf10[m10.pseudo_observables[:Forward5YearRealNaturalRate],:, m10.exogenous_shocks[:b_safep_sh]] ],title="IRFs of r*  to permanent safety shock", label=["Basline model" "No FG model"])
plot!(legend=:bottomright)
savefig( "irf/all/IRF_rstar_to_permanet_safety_shock.pdf")   # saves the plot from p as a .pdf vector graphic

plot(1:horizon,[ pseudo_irf10[ m10.pseudo_observables[:Forward5YearRealNaturalRate],:, m10.exogenous_shocks[:zp_sh ]] ],title="IRFs of r* to permanent technology shock", label=["Basline model" "No FG model" "No convenience yield shocks model"])
plot!(legend=:bottomright)
savefig( "irf/all/IRF_rstar_to_permanet_technology_shock.pdf")   # saves the plot from p as a .pdf vector graphic

plot(1:horizon,[ pseudo_irf10[ m10.pseudo_observables[:Forward5YearRealNaturalRate],:, m10.exogenous_shocks[:z_sh ]] ],title="IRFs of r* to transitory technology shock", label=["Basline model" "No FG model" "No convenience yield shocks model"])
plot!(legend=:bottomright)
savefig( "irf/all/IRF_rstar_to_transitory_technology_shock.pdf")   # saves the plot from p as a .pdf vector graphic

plot(1:horizon,[ pseudo_irf10[ m10.pseudo_observables[:Forward5YearRealNaturalRate],:, m10.exogenous_shocks[:μ_sh ]] ],title="IRFs of r* to investment specific technology shock", label=["Basline model"])
plot!(legend=:bottomright)
