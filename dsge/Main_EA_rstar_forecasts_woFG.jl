...
# --- 5. FINAL EXPORT ---
output_path = joinpath(saveroot, "Final Paper", "EA_rstar_pseudo_realtime_results_woFG.csv")
...
# 9. Save and Display
savefig(joinpath(saveroot, "Final Paper", "EA_rstar_spaghetti_chart_woFG.png"))
display(p)
...
# 8. Save
savefig(joinpath(saveroot, "Final Paper", "EA_rstar_starfish_chart_woFG.png"))
display(p_starfish)