using DSGE, ClusterManagers, HDF5, Plots, StatsPlots, CSV, DataFrames, Dates, FileIO, Measures
...
output_path = joinpath(data_outdir, "rstar_pseudo_realtime_results.csv")
...
fig1_png = joinpath(fig_outdir, "US_rstar_final_chart_2016Q1_panel.png")
fig1_pdf = joinpath(fig_outdir, "US_rstar_final_chart_2016Q1_panel.pdf")
savefig(p, fig1_png)
savefig(p, fig1_pdf)
display(p)
...
# Save both PNG and PDF
fig2_png = joinpath(fig_outdir, "US_rstar_starfish_chart_wFG_2016Q1_panel.png")
fig2_pdf = joinpath(fig_outdir, "US_rstar_starfish_chart_wFG_2016Q1_panel.pdf")
...
# # --- 5. FINAL EXPORT ---
# output_path = joinpath(saveroot,"Final Paper","Figures","Data", "rstar_pseudo_realtime_results.csv")
# CSV.write(output_path, master_df)
# println("Process complete. File saved to $output_path")
...
# # 9. Save and Display
# savefig(joinpath(saveroot,"Final Paper","Figures", "US_rstar_final_chart_long_sample.png"))
# display(p)
...
# # 8. Save
# savefig(joinpath(saveroot,"Final Paper","Figures","US_rstar_starfish_chart_wFG_long_sample.png"))
# display(p_starfish)