...
path = joinpath(saveroot, "output_data", "m1010", "ss20", "forecast", "tables", "hist_Forward5YearRealNaturalRate_cond=none_para=full_vint=250825.csv")
...
p = plot(
    ...
    xlims = (2008.0, 2025.5),
    ylims = (-1.5, 3.5),
    xticks = (collect(2008:1:2025), string.(2008:1:2025)),
    yticks = -1.5:0.5:3.0,
    xlabel = "Year",
    ylabel = "%",
    # title = "r*_t"
